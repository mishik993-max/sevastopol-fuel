...
return [
    ...
    */
    'defaults' => [
        ...
        'qr_reminders' => [
            ['time' => '21:30', 'title' => 'Скоро QR на топливо', 'body' => 'Через полчаса в чате можно будет получить QR-код на топливо'],
            ['time' => '21:45', 'title' => 'QR на топливо', 'body' => 'Через 15 минут откроется получение QR-кода на топливо'],
            ['time' => '21:55', 'title' => 'QR через 5 минут', 'body' => 'Через 5 минут можно получить QR-код на топливо'],
            ['time' => '22:00', 'title' => 'QR доступен', 'body' => 'Сейчас можно получить QR-код на топливо в чате'],
        ],
    ],
