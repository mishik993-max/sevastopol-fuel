...
class StationStatusService
{
    ...
    public function fuelStatus(Station $station, FuelType $fuelType, Collection $reports): array
    {
        ...
        return [
            ...
            'canister_policy' => $latest?->canister_policy?->value,
            'canister_policy_label' => $latest?->canister_policy?->label(),
    ...
    public function formatStation(Station $station, ?FuelType $filterFuel = null, bool $withHistory = false): array
    {
        ...
        $data = [
            ...
            'queue_size' => $activeFuelReport?->queue_size?->value,
            'queue_label' => $activeFuelReport?->queue_size?->label(),
            ...
            'canister_policy' => $activeFuelReport?->canister_policy?->value,
            'canister_policy_label' => $activeFuelReport?->canister_policy?->label(),
